...
export default function Home() {
  ...
  function submitPlayer1(e) {
    e.preventDefault();
    if (
      e.target.player1name.value !== null &&
  ...
  function submitPlayer2(e) {
    e.preventDefault();
    if (
      e.target.player2name.value !== null &&
            ...
            <Fade delay={2100} triggerOnce>
              <AttentionSeeker effect={"bounce"} delay={2100} triggerOnce>
                <div className="home__form__player">
                  <img
                    src={player1Img}
                    className="player-img player1-img"
                    alt="Player 1"
                  />
                  <form onSubmit={submitPlayer1}>
                    <label htmlFor="player1name" className="player1-label">
                      Player 1
                    </label>
                    <input
            ...
            <Fade delay={2100} triggerOnce>
              <AttentionSeeker effect={"bounce"} delay={2200} triggerOnce>
                <div className="home__form__player">
                  <img
                    src={player2Img}
                    className="player-img player2-img"
                    alt="Player 1"
                  />{" "}
                  <form onSubmit={submitPlayer2}>
                    <label htmlFor="player2name" className="player2-label">
                      Player 2{" "}
                    </label>
                    <input
                      className="input-field"
            ...
            <AttentionSeeker effect={"heartBeat"} delay={2400} triggerOnce>
              ...
              >
                ...
                <button
                  className={`${
                    player2 === "" || player1 === ""
                      ? "tooltip-btn disabled-btn"
                      : ""
                  } btn btn-start `}
                  disabled={`${
                    player2 === "" || player1 === "" ? "disabled" : ""
                  }`}
                >
                  Start game
                  <span className="tooltiptext-btn">
                    Please submit a name before starting the game
                  </span>
                </button>
              </a>
            </AttentionSeeker>
