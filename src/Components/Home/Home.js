...
export default function Home() {
  ...
  { submitValue1 } />
      ...
      <div className = "home__form__player">< img
  src = {player2Img} className = "player-img player2-img"
  alt =
  ...
  { submitValue2 } />
      ...
      <AttentionSeeker effect = {"heartBeat"} delay = {2400} triggerOnce>< a
  onClick = {() => { toGame(); }} > < button
                  className={`${
                    player2 === "" || player1 === ""
